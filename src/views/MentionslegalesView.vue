...
<h1 class="mx-24 mt-20 sm:text-xl md:text-2xl lg:text-3xl font-bold font-oswald pt-9">Mentions légales</h1>

    <div class="mx-24">
    <p class="mx-24 mt-10">
        La société sunset, soucieuse des droits des individus, notamment au regard des traitements automatisés et dans une volonté de transparence avec ses clients, a mis en place une politique reprenant l'ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d'actions à la disposition des individus afin qu'ils puissent au mieux exercer leurs droits.
    ...
    <p class="mx-24 mt-10">Sunset</p>
        
    <p class="mx-24 mt-10">1.2 Éditeur (ci-après « l'éditeur »)</p>
        
    <p class="mx-24 mt-10">Sunset au capital de 800 000 € dont le siège social est situé : Boulevard Promenade Veyrier Montagnères 33120 Arcachon 33120 Arcachon représentée par Marion Gillot et immatriculée au RCS de Bordeaux</p>
        
    <p class="mx-24 mt-10">n° de téléphone : 000000000
        adresse mail: sunset@gmail.com
        directeur de la publication : Marion Gillot</p>
        
    <p class="mx-24 mt-10">1.3 Hébergeur (ci-après « l'hébergeur ») 
        
        Sunset est hébergé par Marion Gillot , dont le siège social est situé</p>
        
    <p class="mx-24 mt-10"><strong>Article 2 - Accès au site</strong></p>
        
    <p class="mx-24 mt-10">L'accès au site et son utilisation sont réservés à un usage strictement personnel. Vous vous engagez à ne pas utiliser ce site et les informations ou données qui y figurent à des fins commerciales, politiques, publicitaires et pour toute forme de sollicitation commerciale et notamment l'envoi de courriers électroniques non sollicités.</p>
        
    <p class="mx-24 mt-10"><strong>Article 3 - Contenu du site</strong></p>
        
    <p class="mx-24 mt-10">Toutes les marques, photographies, textes, commentaires, illustrations, images animées ou non, séquences vidéo, sons, ainsi que toutes les applications informatiques qui pourraient 
        être utilisées pour faire fonctionner ce site et plus généralement tous les éléments reproduits ou utilisés sur le site sont protégés par les lois en vigueur au titre de la propriété intellectuelle.</p>
        
    <p class="mx-24 mt-10">Ils sont la propriété pleine et entière de l'éditeur ou de ses partenaires. Toute reproduction, représentation, utilisation ou adaptation, sous quelque forme que ce soit, de tout ou partie de ces éléments, y compris les applications informatiques, sans l'accord préalable et écrit de l'éditeur, sont strictement interdites. Le fait pour l'éditeur de ne pas engager de procédure dès la prise de connaissance de ces utilisations non autorisées ne vaut pas acceptation desdites utilisations et renonciation aux poursuites.</p>
        
    <p class="mx-24 mt-10"><strong>Article 4 - Gestion du site</strong></p>
        
    <p class="mx-24 mt-10">Pour la bonne gestion du site, l'éditeur pourra à tout moment :
    ...
    <ul class="mx-24 mt-10">
        ...
        <li>• le droit à la portabilité: ils peuvent réclamer que la Plateforme leur remette les données personnelles qu'ils ont fournis pour les transmettre à une nouvelle plateforme.</li>
    </ul>
        
    <p class="mx-24 mt-10">Vous pouvez exercer ce droit en nous contactant à l'adresse suivante : Boulevard Promenade Veyrier Montagnères 33120 Arcachon
        
        Toute demande doit être accompagnée de la photocopie d'un titre d'identité en cours de validité signé et faire mention de l'adresse à laquelle l'éditeur pourra contacter le demandeur. La réponse sera adressée dans le mois suivant la réception de la demande. Ce délai d'un mois peut être prolongé de deux mois si la complexité de la demande et/ou le nombre de demandes l'exigent.</p>
        
    <p class="mx-24 mt-10">De plus, et depuis la loi n°2016-1321 du 7 octobre 2016, les personnes qui le souhaitent, ont la possibilité d'organiser le sort de
        leurs données après leur décès. Pour plus d'information sur le sujet, vous pouvez consulter le site Internet de la CNIL : https://www.enil.fr/.</p>
        
    <p class="mx-24 mt-10">Les utilisateurs peuvent aussi introduire une réclamation auprès de la CNIL sur le site de la CNIL : https://www.enil.fr.
        Nous vous recommandons de nous contacter dans un premier temps avant de déposer une réclamation auprès de la CNIL, car à votre entière disposition pour régler votre problème.</p>
    ...
    <ul class="mx-24 mt-10">
        ...
        <li>- quand la Plateforme recourt aux services de prestataires pour fournir l'assistance utilisateurs, la publicité et les services de paiement.
    ...
    <p class="mx-24 mt-10">Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant: sunset@gmail.com
        Vos données sont susceptibles d'être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : sunset@gmail.com
        ...
        L'éditeur décline toute responsabilité à cet égard. Les données sont conservées et utilisées pour une durée conforme à la législation en vigueur.</p>
        ...
        <p class="mx-24 mt-10">Les photographies de produits, accompagnant leur description, ne sont pas contractuelles et n'engagent pas l'éditeur.</p>
        
        <p class="mx-24 mt-10"><strong>Article 15 - Loi applicable</strong></p>

        <p class="mx-24 mt-10">Les présentes conditions d'utilisation du site sont régies par la loi française et soumises à la compétence des tribunaux du siège social de l'éditeur, sous réserve d'une attribution de compétence spécifique découlant d'un texte de loi ou réglementaire particulier.</p>
