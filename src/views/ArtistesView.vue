...
<div class="mt-20 mx-auto flex justify-center">
    <div class="w-[477px] h-[122px] bg-transparent border-[3px] border-illustrationrose">
        <p class="text-center font-bold text-2xl p-9">Pnl - Jul - Ziak - Gazo</p>
    </div>
</div>
...
<p class="text-center mt-20">N’hésitez pas à partager notre événement à vos amis ou sur vos réseaux sociaux avec ce QR codee </p>
