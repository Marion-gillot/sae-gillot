<template>
  <main>
    ...
    <div class="mt-28">
      <p class="text-center font-bold sm:text-xl md:text-1xl lg:text-2xl">La musique commence là où s'arrête le pouvoir des mots.</p>
      <p class="text-center text-illustrationrose mt-5">Richard Wagner</p>
